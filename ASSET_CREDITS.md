...
| **Oversized Hoodie** | `public/models/hoodie.glb` | ⚠️ VERIFIKASI — tercatat "3D Garment Asset Vault", tanpa URL/author/invoice | ⚠️ VERIFIKASI — TANPA KLAIM (lihat §4) | 402 KB (optimized Draco) | Active (Production) — lisensi belum terlacak |
