...
| **Heavyweight Boxy Longsleeve** | `public/models/longsleeve.glb` | Derived from Open 3D Apparel Library with organic arm folds & 5cm ribbed cuffs | CC-BY 4.0 | 1.2 MB | Active Production |
| **Oversized Hoodie** | `public/models/hoodie.glb` | 3D Garment Asset Vault | CC-BY 4.0 | 402 KB (optimized Draco) | Active (Production) |
