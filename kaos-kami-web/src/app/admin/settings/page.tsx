      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-surface border border-border-subtle rounded-2xl p-5 space-y-3">
          ...
          <div className="space-y-2 text-[11px]">
            <div><span className="block text-text-muted">ALAMAT WORKSHOP</span><span className="text-text-primary font-bold">{shopAddress}</span></div>
            <div><span className="block text-text-muted">KODE POS ASAL (ONGKIR)</span><span className="text-text-primary font-bold">{shopPostal}</span></div>
            <div><span className="block text-text-muted">WHATSAPP</span><span className="text-brand-accent font-bold">{shopWa}</span></div>
            <div><span className="block text-text-muted">SITE URL</span><span className="text-text-primary">{siteUrl}</span></div>
            <div><span className="block text-text-muted">R2 BUCKET</span><span className="text-text-primary">{r2Bucket} → {r2Url}</span></div>
          </div>
        </div>
        <div className="bg-surface border border-border-subtle rounded-2xl p-5 space-y-3">
