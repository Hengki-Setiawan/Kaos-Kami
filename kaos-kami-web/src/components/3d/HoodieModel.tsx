...
const MODEL_PATH_HIGH = "/models/hoodie.optimized.glb";
const MODEL_PATH_LOW = "/models/hoodie.lod1.glb";
const MODEL_PATH = "/models/hoodie.glb"; // legacy fallback
...
const GltfHoodie: React.FC = () => {
  ...
  const mergedGeometry = useMemo(() => {
    ...
    try {
      ...
      if (merged) {
        ...
        // WAJIB: bobot wind ( Sullivan preset wind) + box-UV ( Sullivan normal anyaman,
        // mesh hoodie mentah Marvelous tanpa UV).
  ...
  // Geometri cache GLB milik drei — JANGAN dispose.
  useEffect(() => {
    return () => {
      try {
